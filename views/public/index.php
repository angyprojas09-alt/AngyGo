...
<body>
    ...
    <section class="contacto" id="contacto">
        ...
        <p>📧 Correo: <a href="mailto:angygo916@gmail.com">angygo916@gmail.com</a></p>
        ...
        <div class="formulario">
            ...
            <form action="../controllers/guardar_pedido.php" method="POST" onsubmit="return disableSubmit(this);">
                ...
                <input type="text" id="nombre" name="nombre" value="<?php echo htmlspecialchars($usuario); ?>" required>
